...
//  57, 60, 62, 64, 65, 67, 69, 71, 72
    ...
    case 1:
      //a =1;
      noteOn(mchannel, 57, 0x00);
      break;

    case 2:
     // a=2;
      noteOn(mchannel, 60, 0x00);
      break;

    case 3:
     // a=3;
      noteOn(mchannel, 62, 0x00);
      break;

    case 4:
     // a=4;
      noteOn(mchannel, 64, 0x00);
      break;

    case 5:
    //  a=5;
      noteOn(mchannel, 65, 0x00);
      break;

    case 6:
     // a=6;
      noteOn(mchannel, 67, 0x00);
      break;

    case 7:
      a=7;
      noteOn(mchannel, 69, 0x00);
      break;

    case 8:
     // a=8;
      noteOn(mchannel, 71, 0x00);
      break;

    case 9:
     // a=9;
      noteOn(mchannel, 72, 0x00);
      break;
