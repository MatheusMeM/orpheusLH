...
void loop()

   {
    ...
    if (sensorState == HIGH)
       {
       if (notesonoff[m] == 0)    // note status was off
          {
           ...
           notesonoff[m] = 1;     // sets note status to on 
          }
       }
       ...
       if (sensorState == LOW)
          {
           if (notesonoff[m] == 1)    // note status was on
              {
               ...
               notesonoff[m] = 0;     // sets note status to on
              }
          }    
